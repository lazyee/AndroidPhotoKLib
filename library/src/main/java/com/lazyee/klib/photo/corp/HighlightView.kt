...
internal class HighlightView(
    ...
    private fun initStyles(context: Context) {
        ...
        try {
            ...
            handleMode =
                HandleMode.values()[attributes.getInt(R.styleable.CropImageView_showHandles,
                    0)]
        } finally {
            attributes.recycle()
        }
    ...
    fun setup(m: Matrix?, imageRect: Rect?, cropRect: RectF?, maintainAspectRatio: Boolean) {
        ...
        outsidePaint.setARGB(150, 0, 0, 0)
    ...
    private fun drawOutsideFallback(canvas: Canvas) {
        ...
        canvas.drawRect(0f,
            ...
            drawRect!!.bottom.toFloat(),
            outsidePaint)
        canvas.drawRect(drawRect!!.right.toFloat(),
            drawRect!!.top.toFloat(),
            canvas.width.toFloat(),
            drawRect!!.bottom.toFloat(),
            outsidePaint)
    ...
    fun getScaledCropRect(scale: Float): Rect {
        return Rect((cropRect!!.left * scale).toInt(), (cropRect!!.top * scale).toInt(),
    ...
    companion object {
        ...
        private const val DEFAULT_HIGHLIGHT_COLOR = -0x1
